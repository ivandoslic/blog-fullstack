<template>
  <div class="w-full h-full flex flex-row justify-center items-center">
    <div class="w-[30%] flex flex-col h-full center text-center px-10 justify-center items-center">
        <img src="../assets/images/logo.png" class="w-[35%] mb-12 animate-bounce quick-bounce"/>
        <h1 class="text-4xl mb-3 font-bold">Welcome back</h1>
        <p class="text-sm text-gray-700 mb-5">Please enter your details</p>
    ...
    setup() {
        ...
        const onSubmit = async () => {
            ...
            if (username.value.trim().length == 0) {
                ...
                errorMessage.value = 'You must enter your username';
            ...
            if (password.value.trim().length == 0) {
                errorOccured.value = true;
                errorMessage.value = 'You must enter your password';
                buttonDisabled.value = false;
                return;
            }
